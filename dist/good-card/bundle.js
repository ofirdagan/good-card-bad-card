...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__devtools__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__with_render_count__ = __webpack_require__(20);





class GoodCardAppRootComponent extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__devtools__["a" /* default */], null), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", null, "Cards With Values: ", this.state.cardsWithValuesCount), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("form", {
      className: 'form'
    }, cards));
  }
...
class CardComp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.PureComponent {
  render() {
    const {
      index,
      value,
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
      ...
      title: `Card ${index}`
    }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(CardContent, {
      index: index,
      value: value,
      handleChange: handleChange
    }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(CardFooter, {
      footNote: `foot note of card ${index}`
    }));
  }

}

class CardHeaderComp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  render() {
    const {
      title
    } = this.props;
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", null, title);
  }

}

class CardContentComp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  render() {
    const {
      index,
      value,
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(InputComponent, {
      key: index,
      index: index,
      value: value,
      handleChange: handleChange
...
class InputComponentComp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  render() {
    ...
    }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(GrandChild, {
...
class GrandChildComp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  render() {
    const {
      hasValue
    } = this.props;
    const text = hasValue ? 'has value' : '';
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, text);
  }

}

class CardFooterComp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  render() {
    const {
      footNote
    } = this.props;
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h4", null, footNote);
  }

}

const Card = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('Card', CardComp);
const CardHeader = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('CardHeader', CardHeaderComp);
const CardFooter = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('CardFooter', CardFooterComp);
const CardContent = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('CardContent', CardContentComp);
const GrandChild = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('GrandChild', GrandChildComp);
const InputComponent = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('InputComponent', InputComponentComp);
const GoodCardAppRoot = Object(__WEBPACK_IMPORTED_MODULE_3__with_render_count__["a" /* default */])('GoodCardAppRootComponent', GoodCardAppRootComponent);
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(GoodCardAppRoot, null), document.getElementById('root'));
...
class Devtools extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", {
      className: 'devtools'
    }, "For this demo to work well, open your dev tools");
  }

}
/* harmony export (immutable) */ __webpack_exports__["a"] = Devtools;
...
const withRenderCount = (name, Comp) => {
  return class WithRenderComponent extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.PureComponent {
    constructor(props) {
      super(props);
      this.renderCount = 0;
    }
    ...
    render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Comp, this.props);
    }

  };
};

/* harmony default export */ __webpack_exports__["a"] = (withRenderCount);
